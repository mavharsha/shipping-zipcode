...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Based on the inputs in resources/ListOfShippingZipCodeRanges.json, the following ranges " +
                "are consolidate shippable ranges:");
        try {
            ...
            for (int index = 0; index < listOfShippableRanges.size(); index++) {
                System.out.println("[ "+ listOfShippableRanges.get(index).getLowerRange().getCode() + ", "
                        + listOfShippableRanges.get(index).getUpperRange().getCode() + " ]");
            }
        } catch (Exception e) {
